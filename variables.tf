...
variable "ami" {
  default     = ""
  type        = string
  description = "The AMI to use for the SSM Agent EC2 Instance. If not provided, the latest Amazon Linux 3 AMI will be used. Note: This will update periodically as AWS releases updates to their AL3 AMI. Pin to a specific AMI if you would like to avoid these updates."
}
